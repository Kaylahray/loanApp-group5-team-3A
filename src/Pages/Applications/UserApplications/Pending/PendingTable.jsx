...
import PendingData from "../Pending/PendingData";
...
const PendingTable = ({ value }) => {
  ...
  const currentPost = PendingData.slice(indexOfFirst, indexOfLast);
  const paginate = (pageNumber) => setCurrentPage(pageNumber);
  const page = Math.ceil(PendingData.length / postPerPage);
