...
import MineData from "../Mine/MineData";
...
const MineTable = ({ value }) => {
  ...
  const currentPost = MineData.slice(indexOfFirst, indexOfLast);
  const paginate = (pageNumber) => setCurrentPage(pageNumber);
  const page = Math.ceil(MineData.length / postPerPage);
