...
export default function MessageCenter() {
  const [messages, setMessages] = useState([
    ...
    { message: "Hi, this is Chinonso. Please where can we meet to talk", sentMessage: false },
    { message: "Hi, this is juliet. Please where can we meet to talk", sentMessage: true }
  ]);
    ...
    <div className="child-container-2">
      ...
      <div className="message">
        {messages.map((item, key) =>
          item.sentMessage ? <SentMessage key={key} message={item.message} /> : <ReceivedMesssage key={key} message={item.message} />
        )
        }
      </div>
